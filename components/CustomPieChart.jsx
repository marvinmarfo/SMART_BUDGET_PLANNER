...
export default function CustomPieChart({categoryList}) {
...
//       {categoryList?.length==0? <View style={{display:'flex', flexDirection:'row', gap:5, alignItems:'center'}}>
...
//             <MaterialCommunityIcons name="checkbox-blank-circle" size={22} color={Colors.COLOR_LIST[index]} />
